...
7. Dipendenze: `nodemailer` 10.0.10 (SMTP) e `imapflow` 2.0.7 (IMAP), installate.
   Da archiviare nel [registro delle fonti](docs/fonti/README.md): [Specifiche tecniche SdI, Allegato B DM 55/2013, v1.8.4 del 31/03/2026](https://www.fatturapa.gov.it/export/documenti/Specifiche-tecniche-relative-al-Sistema-di-Interscambio-versione-1.8.4.pdf), la fonte del canale PEC: §3.1.1 per l'invio e §3.2.1 per la ricezione.
