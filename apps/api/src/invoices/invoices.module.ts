...
@Module({ imports: [FiscalRulesModule, TenantsModule], controllers: [InvoiceImportController, InvoiceFilesController, RevenueThresholdsController, InvoicesController], providers: [InvoicesService, InvoicesImportService, InvoicesPdfService, InvoiceStatusService], exports: [InvoicesService, InvoiceStatusService] })
